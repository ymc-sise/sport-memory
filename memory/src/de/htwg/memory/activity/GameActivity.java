...
/**
 * this class represent the game activity
 * 
...
public class GameActivity extends Activity {
    ...
    private void createNewGame() throws JSONException, IOException {    	
    	//send an http request to the web server to get the ids for the memory cards
	    	    ...
	    	    tr.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
	       	    ...
	       	    for(int j=0; j<y; j++) {
					...
					try {
		    	    	...
		    	    	//create new memory card and set it clickable
	...
	class MemoryTimerTask extends TimerTask {		
		...
		public void stopTask(){	
			...
			int anz = getTries();
			int time = getTime();
			String formattedTime = formatTimeToString(time);
		 	String name = getName();
			AlertDialog.Builder builder = new AlertDialog.Builder(gameActivity);
			builder.setTitle("You have won!")
			       .setCancelable(false)
			       .setMessage(name + " has needed " + anz + " tries and " + formattedTime +" of time.")
